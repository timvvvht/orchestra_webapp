...
import RepositoryFilterDropdown from "./RepositoryFilterDropdown";
      ...
      <div className="flex-shrink-0 bg-black/50 backdrop-blur-sm border-b border-white/10">
        <div className="px-6 py-3 flex items-center justify-between">
          <div className="flex items-center justify-between w-full gap-3">
            ...
            <span className="bg-red-300 text-xl">{archiveLoading}</span>
      ...
      >
        <div className="min-h-[400px]">
          <div className="py-4">
            ...
            {viewMode === "archived" &&
              useMissionControlStore.getState().archiveLoading && (
            ...
            {viewMode === "archived" &&
              ...
              archivedSessions.length > 0 && (
                <AgentGroup
                  ...
                  isCollapsed={collapsedGroups.archived}
                  groupKey="archived" // Use drafts as placeholder since archived doesn't collapse
                >
                  <div className="px-6">
                    {archivedSessions.map((agent) => (
                      <AgentCard
                        key={agent.id}
                        agent={agent}
                        group="idle"
