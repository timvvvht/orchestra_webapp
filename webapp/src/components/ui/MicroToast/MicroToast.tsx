...
export const MicroToast: React.FC<MicroToastProps> = ({
  ...
  const Arrow = () => {
    ...
    const arrowClasses = {
      top: isLeftAligned
        ? "left-6 top-full -translate-x-1/2 rotate-0"
        : "left-2/3 top-full -translate-x-1/2 rotate-0",
      bottom: isLeftAligned
        ? "left-6 -top-1 -translate-x-1/2 rotate-180"
        : "left-2/3 -top-1 -translate-x-1/2 rotate-180",
      ...
      >
        ...
        <motion.div
          ...
          className={cn(
            ...
            isSuccess &&
              "bg-emerald-400/90 shadow-[0_0_8px_rgba(16,185,129,0.4)]",
