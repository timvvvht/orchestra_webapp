  ...
  const loadDiffStats = async () => {
    ...
    try {
      ...
      if (checkpoints.length >= 2 && agent.agent_cwd) {
        ...
        const { filesChanged, additions, deletions } = getDiffStatsFromUnifiedDiff(diffString);
      ...
      <div className="px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {/* Session Title */}
            <h2 className="text-sm font-medium text-white/90 max-w-[500px]" title={agent.mission_title}>
              {agent.mission_title}
            </h2>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center bg-white/[0.02] backdrop-blur-sm rounded-lg p-0.5 border border-white/[0.06]">
              ...
              <button
                ...
                `}
                title={!hasPlan ? 'No plan available for this session' : undefined}
              >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48 bg-black/95 backdrop-blur-xl border-white/10">
                {agent.agent_cwd && (
                  <DropdownMenuItem 
                    onClick={() => navigator.clipboard.writeText(agent.agent_cwd!)}
