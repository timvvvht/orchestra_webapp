...
import { ChevronRight, Archive, ArchiveRestore, Loader2, FileText, Lock, Clock } from 'lucide-react';
...
import PlanMarkdownModal from './PlanMarkdownModal';
        ...
        <div className={`relative px-6 py-5`}>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-xs text-white/50 font-mono truncate">{codePath}</div>
            </div>
          </div>
