...
import { X, FolderPlus, FolderOpen, ArrowRight, Sparkles, GitBranch, Save, Shield } from 'lucide-react';
...
export const ProjectSelectionModal: React.FC<ProjectSelectionModalProps> = ({ 
  ...
  const handleNewProject = async () => {
    if (isTauri()) {
      ...
      if (projectName?.trim()) {
        const parentPath = window.prompt('Enter parent directory path:') || '/Users/default/projects';
        ...
        >
          ...
          <div className="relative z-10 p-10">
            ...
            {recentProjects.length > 0 && (
              <div>
                <h3 className="text-sm font-medium text-white/50 mb-3">Recent Projects</h3>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-white/40 font-mono">{project.path}</div>
                          </div>
                        </div>
