...
const QuantumWaveIndicator: React.FC<QuantumWaveIndicatorProps> = ({ 
  ...
  const [currentColor, setCurrentColor] = useState<[number, number, number]>(blueRGB);
  ...
  const currentColorAlpha = (alpha: number) => `rgba(${currentColor[0]}, ${currentColor[1]}, ${currentColor[2]}, ${alpha})`;
