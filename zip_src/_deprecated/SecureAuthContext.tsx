...
import { SupabaseOAuthManager, TauriOAuthManager } from '@/lib/secureAuth/supabaseIntegration';
import { SecureUser, AuthEventType } from '@/lib/secureAuth/types';
...
export const SecureAuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const isTauriEnvironment = TauriOAuthManager.isTauriEnvironment();
