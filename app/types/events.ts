...
export const KindEnum = z.enum(['message', 'tool_call', 'tool_result', 'checkpoint']);
...
export const CanonicalEvent = z.union([MessageEvent, ToolCallEvent, ToolResultEvent, CheckpointEvent]);
...
export const isToolCallEvent = (event: CanonicalEvent): event is ToolCallEvent =>
  event.kind === 'tool_call';

export const isToolResultEvent = (event: CanonicalEvent): event is ToolResultEvent =>
  event.kind === 'tool_result';

export const isCheckpointEvent = (event: CanonicalEvent): event is CheckpointEvent =>
...
export const safeValidateCanonicalEvent = (data: unknown): { 
  success: boolean; 
  data?: CanonicalEvent; 
  error?: z.ZodError 
} => {
