 ...
 */
export function groupMessagesIntoResponses(
 ...
 */
export function getToolCallsForResponse(
  messages: ChatMessage[],
  finalMessageId: string
): UnifiedToolCall[] {
  const responses = groupMessagesIntoResponses(messages);
 ...
 */
function extractFileOperationsFromMessages(
  messages: ChatMessage[]
): ExtendedFileOperation[] {
 ...
 */
export function getFinalMessageStatus(
  message: ChatMessage,
  allMessages: ChatMessage[]
): "streaming" | "final" | "intermediate" {
